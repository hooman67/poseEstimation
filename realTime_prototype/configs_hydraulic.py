# CONFIGS
mainPath = '/media/hooman/961293e3-04a5-40c5-afc0-2b205d0a7067/WM_PROJECT/algorithmDev/wmAlgo_usingWearLandmarsk_optical_hydraulics/try1/wmdlLogs_aitik_Komatsu_SH1142_PC5500_2019-02-26_to_2019-03-10/'
...
##########THESE ARE GLOBAL##############
NUMBER_OF_TEETH = 6  #for cable 8  for hydraulic 6
...
#for registration
'''
#for hydraulic test used referenceFrames/images/WMDL_2019.02.27_10.03.11.png'
...
'''
#for hydraulic test used 
references2use = ['WMDL_2019.02.27_10.03.11']
...
regEr_WithLs_lessThan_withAll_multiple = 1 # used 1 for hydraulic. For cable 1000 to disable this.